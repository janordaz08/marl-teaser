(function() {
	...
	homeCtrl.$inject = ['$scope', '$timeout', '$state', '$stateParams', 'appService', 'Constants'];
	
	function homeCtrl($scope, $timeout, $state, $stateParams, appService, Constants) {
        var vm = this;
        ...
        function init() {
            ...
            vm.level = {r:3,c:3,n:1,l:1,s:1,p:25};
...
//        	vm.completed = true;
        ...
        function homePage() {
        	window.location.href = "https://marlboro.ph/register?scanpack=szIQ0Fv0qVgKd4PgydpGHzyv309v5RCnheLAds7TmzSxnAIIXRSnuJQuVqYV";
        }
